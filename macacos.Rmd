...
## Metadata & Facts on Territorial Conflicts [This is not an official webpage! Working in progress.]
...
plot_ly() %>% add_pie(data = macacos, 
              ...
              layout(autosize = F, title = "",  showlegend = TRUE,
...
fig <- fig %>% layout(title = 'Affected People by Neighbourhood and Register Status',
...
\
Questionnaires answered by the affected people separated into three categories: Answered, Not Answered and Partially Answered. 
\
\
